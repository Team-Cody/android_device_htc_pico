...
TARGET_SPECIFIC_HEADER_PATH := device/htc/pico/include_vsync
...
COMMON_GLOBAL_CFLAGS += -DQCOM_HARDWARE -DREFRESH_RATE=65 -DQCOM_NO_SECURE_PLAYBACK -DQCOM_ICS_DECODERS -DANCIENT_GL
